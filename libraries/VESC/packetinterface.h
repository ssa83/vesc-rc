...
//        QString meta_description;
    ...
    {
    public:
        TBuffer(unsigned char* _buf = 0, unsigned int _len = 0)
            : buf(_buf)
            , len(_len)
            {}
        unsigned char* buf;
    ...
    void processData(unsigned char *data, unsigned int len);
...
private:
    ...
    static const unsigned int mMaxRxBufferLen = 64;
    static const unsigned int mMaxTxBufferLen = 32;
    static const unsigned int mMaxSendBufferLen = 32;
    int mRxTimer;
    int mRxState;
    unsigned int mPayloadLength;
    unsigned char mRxBuffer[mMaxRxBufferLen];
    unsigned int mRxDataPtr;
    unsigned char mCrcLow;
    unsigned char mCrcHigh;
    
    unsigned char mTxBuffer[mMaxTxBufferLen];
};
